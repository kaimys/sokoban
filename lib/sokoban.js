...
var matFloorOpts = {
  ambient: 0x101010, color: 0x999999, specular: 0x009900,
...
var matBoxOpts = {
  ambient: 0x606060, color: 0xccb687, specular: 0x009900,
  shininess: 60, shading: THREE.FlatShading
};
...
function init() {
  ...
  light = new THREE.PointLight(0x62f0ff, 0.4);
  light.position.set(-300, -300, 500);
  scene.add(light);
  light = new THREE.PointLight(0xff87d7, 0.4);
  light.position.set(300, -300, 500);
  scene.add(light);
